---
name: the current project brand
...
Redesign the frontend of the current project brand so it feels premium, modern, and visually fresh without breaking backend functionality.
